using Aveneo.WebApi.Configuration.Jwt;
using Aveneo.WebApi.Data;
using Aveneo.WebApi.Services.ExchangeRate;
using Aveneo.WebApi.Services.ExchangeRate.Interfaces;
using Aveneo.WebApi.Services.Token;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Aveneo.WebApi v1"));
            }
            app.UseSession();
